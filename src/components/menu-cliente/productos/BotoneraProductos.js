  ...
  return (
    <div>
      <Button
        ...
        className={`${
          productos.destacado
            ? "bg-dark border-dark text-light p-1"
            : "p-1 bg-light border-dark text-dark"
        }`}
      ...
      <Button
        as={Link}
        to={`/admin-cliente/productos/editarProducto/${productos.id}`}
        title="Editar"
      ...
      <Button
        ...
        className={`${
          productos.publicado
            ? "bg-primary text-light p-1 ms-1"
            : "ms-1 p-1 bg-light border-dark text-dark"
        }`}
